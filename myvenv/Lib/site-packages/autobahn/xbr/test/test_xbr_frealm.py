...
class TestFederatedRealm(TestCase):
    ...
    #
    @skipIf(
        IS_CPY_310, "Web3 v5.29.0 (web3.auto.infura) raises TypeError on Python 3.10"
    )
    ...
    def test_frealm_seeders(self):
        ...
        self.assertEqual(
            transports,
            [
                "wss://frealm1.example.com/ws",
                "wss://fr1.foobar.org/ws",
    ...
    def test_frealm_secmod(self):
        ...
        self.assertEqual(
            authextra.get("pubkey", None), client_key.public_key(binary=False)
        )
