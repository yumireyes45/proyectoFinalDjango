...
_lr_goto_items = {
    "translation_unit_or_empty": ([0,], [1,]),
    "translation_unit": ([0,], [2,]),
    "empty": (
        [
            0,
            11,
    ...
    "external_declaration": ([0, 2,], [4, 64,]),
    "function_definition": ([0, 2,], [5, 5,]),
    "declaration": (
        [0, 2, 11, 67, 73, 128, 221, 372,],
        [6, 6, 68, 129, 68, 223, 223, 482,],
    ),
    "pp_directive": ([0, 2,], [7, 7,]),
    "pppragma_directive": (
        [
            0,
            2,
    ...
    "static_assert": (
        [0, 2, 128, 221, 242, 358, 360, 369, 470, 525, 526, 527, 570, 582, 584,],
        [10, 10, 232, 232, 232, 232, 232, 232, 232, 232, 232, 232, 232, 232, 232,],
    ),
    "id_declarator": (
        [0, 2, 12, 17, 26, 69, 70, 82, 134, 192, 194, 209, 322, 466,],
        [11, 11, 73, 93, 111, 130, 111, 93, 130, 315, 130, 130, 93, 130,],
    ),
    "declaration_specifiers": (
        [0, 2, 11, 67, 73, 96, 128, 137, 221, 313, 322, 351, 372, 449, 458,],
        [12, 12, 69, 69, 69, 192, 69, 192, 69, 192, 192, 192, 69, 192, 192,],
    ),
    "decl_body": (
        [0, 2, 11, 67, 73, 128, 221, 372,],
    ...
    "direct_id_declarator": (
        [0, 2, 12, 17, 20, 26, 69, 70, 80, 82, 134, 192, 194, 209, 318, 322, 452, 466,],
        [19, 19, 19, 19, 97, 19, 19, 19, 97, 19, 19, 19, 19, 19, 97, 19, 97, 19,],
    ),
    "pointer": (
        [0, 2, 12, 17, 26, 69, 70, 82, 113, 134, 192, 194, 209, 216, 322, 351, 466,],
        [20, 20, 80, 20, 20, 80, 20, 80, 196, 80, 318, 80, 80, 352, 452, 352, 80,],
    ),
    "type_qualifier": (
        [
            0,
    ...
    "declaration_list_opt": ([11, 73,], [65, 131,]),
    "declaration_list": ([11, 73,], [67, 67,]),
    "init_declarator_list_opt": ([12, 69,], [79, 79,]),
    "init_declarator_list": ([12, 69,], [84, 84,]),
    "init_declarator": ([12, 69, 134, 194,], [85, 85, 253, 326,]),
    "declarator": ([12, 69, 134, 194, 209, 466,], [86, 86, 86, 86, 346, 346,]),
    "typeid_declarator": (
        [12, 69, 82, 134, 194, 209, 466,],
        [87, 87, 133, 87, 87, 87, 87,],
    ),
    "direct_typeid_declarator": (
        [12, 69, 80, 82, 134, 194, 209, 466,],
        [88, 88, 132, 88, 88, 88, 88, 88,],
    ),
    "declaration_specifiers_no_type_opt": (
        [21, 22, 23, 27, 34, 71, 101,],
        [98, 102, 103, 112, 117, 117, 117,],
    ),
    "id_init_declarator_list_opt": ([26, 70,], [105, 105,]),
    "id_init_declarator_list": ([26, 70,], [108, 108,]),
    "id_init_declarator": ([26, 70,], [110, 110,]),
    "type_qualifier_list_opt": (
        [30, 95, 136, 183, 258, 323, 448, 511,],
        [113, 182, 257, 309, 401, 455, 510, 544,],
    ),
    "type_qualifier_list": (
        [
            30,
    ...
    "constant_expression": (
        [94, 126, 234, 332, 347, 397, 467,],
        [142, 218, 359, 462, 468, 491, 523,],
    ),
    ...
    "parameter_type_list": (
        [96, 137, 322, 351, 449, 458,],
        [185, 260, 454, 454, 513, 454,],
    ),
    "identifier_list_opt": ([96, 137, 449,], [186, 261, 514,]),
    "parameter_list": ([96, 137, 322, 351, 449, 458,], [187, 187, 187, 187, 187, 187,]),
    "identifier_list": ([96, 137, 449,], [189, 189, 189,]),
    "parameter_declaration": (
        [96, 137, 313, 322, 351, 449, 458,],
        [190, 190, 444, 190, 190, 190, 190,],
    ),
    "enumerator_list": ([120, 198, 199,], [200, 328, 329,]),
    "enumerator": ([120, 198, 199, 331,], [201, 201, 201, 461,]),
    "struct_declaration_list": ([124, 203, 204,], [205, 333, 335,]),
    "brace_close": (
        [124, 200, 203, 204, 205, 219, 328, 329, 333, 335, 390, 487, 537, 562,],
        [206, 330, 334, 336, 337, 355, 459, 460, 463, 464, 486, 531, 561, 574,],
    ),
    "struct_declaration": (
        [124, 203, 204, 205, 333, 335,],
        [207, 207, 207, 338, 338, 338,],
    ),
    "specifier_qualifier_list": (
        [124, 125, 126, 141, 203, 204, 205, 238, 294, 298, 299, 304, 333, 335,],
        [209, 216, 216, 216, 209, 209, 209, 216, 216, 216, 216, 216, 209, 209,],
    ),
    "type_name": (
        [125, 126, 141, 238, 294, 298, 299, 304,],
        [215, 217, 264, 364, 435, 436, 437, 438,],
    ),
    "block_item_list_opt": ([128,], [219,]),
    "block_item_list": ([128,], [221,]),
    "block_item": ([128, 221,], [222, 356,]),
    "statement": (
        [128, 221, 242, 358, 360, 369, 470, 525, 526, 527, 570, 582, 584,],
        [224, 224, 370, 370, 370, 479, 370, 553, 370, 370, 370, 370, 370,],
    ),
    "labeled_statement": (
        [128, 221, 242, 358, 360, 369, 470, 525, 526, 527, 570, 582, 584,],
    ...
    "initializer": ([135, 195, 393, 532,], [254, 327, 488, 560,]),
    "assignment_expression_opt": (
        [182, 257, 455, 457, 510,],
        [305, 399, 517, 519, 542,],
    ),
    "typeid_noparen_declarator": ([192,], [316,]),
    "abstract_declarator_opt": ([192, 216,], [317, 350,]),
    "direct_typeid_noparen_declarator": ([192, 318,], [319, 446,]),
    "abstract_declarator": ([192, 216, 322, 351,], [321, 321, 450, 450,]),
    "direct_abstract_declarator": (
        [192, 216, 318, 322, 351, 352, 452,],
        [325, 325, 447, 325, 325, 447, 447,],
    ),
    "struct_declarator_list_opt": ([209,], [339,]),
    "struct_declarator_list": ([209,], [344,]),
    "struct_declarator": ([209, 466,], [345, 522,]),
    "pragmacomp_or_statement": (
        [242, 358, 360, 470, 525, 526, 527, 570, 582, 584,],
        [368, 469, 471, 524, 552, 555, 556, 579, 585, 586,],
    ),
    "pppragma_directive_list": (
        [242, 358, 360, 470, 525, 526, 527, 570, 582, 584,],
        [369, 369, 369, 369, 369, 369, 369, 369, 369, 369,],
    ),
    "assignment_operator": ([250,], [378,]),
    "initializer_list_opt": ([256,], [390,]),
    "initializer_list": ([256, 498,], [391, 537,]),
    "designation_opt": ([256, 487, 498, 562,], [393, 532, 393, 532,]),
    "designation": ([256, 487, 498, 562,], [394, 394, 394, 394,]),
    "designator_list": ([256, 487, 498, 562,], [395, 395, 395, 395,]),
    "designator": ([256, 395, 487, 498, 562,], [396, 490, 396, 396, 396,]),
    "argument_expression_list": ([288,], [428,]),
    "parameter_type_list_opt": ([322, 351, 458,], [451, 451, 521,]),
    "offsetof_member_designator": ([507,], [540,]),
}
