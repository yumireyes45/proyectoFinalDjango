...
from OpenSSL._util import UNSPECIFIED as _UNSPECIFIED
...
from OpenSSL._util import make_assert as _make_assert
from OpenSSL._util import no_zero_allocator as _no_zero_allocator
from OpenSSL._util import path_bytes as _path_bytes
from OpenSSL._util import text_to_bytes_and_warn as _text_to_bytes_and_warn
...
class _CookieGenerateCallbackHelper(_CallbackExceptionHelper):
    def __init__(self, callback):
        ...
        self.callback = _ffi.callback(
            "int (*)(SSL *, unsigned char *, unsigned int *)", wrapper,
        )
...
class Context:
    ...
    def set_cookie_generate_callback(self, callback):
        ...
        _lib.SSL_CTX_set_cookie_generate_cb(
            self._context, self._cookie_generate_helper.callback,
        )
    ...
    def set_cookie_verify_callback(self, callback):
        ...
        _lib.SSL_CTX_set_cookie_verify_cb(
            self._context, self._cookie_verify_helper.callback,
        )
