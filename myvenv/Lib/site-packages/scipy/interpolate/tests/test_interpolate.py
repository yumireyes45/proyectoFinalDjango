...
class TestInterp1D:
    ...
    def test_cubic(self):
        ...
        assert_array_almost_equal(
            interp10([2.4, 5.6, 6.0]), np.array([2.4, 5.6, 6.0]),
        )
    ...
    def test_nearest(self):
        ...
        assert_array_almost_equal(
            interp10([2.4, 5.6, 6.0]), np.array([2.0, 6.0, 6.0]),
        )
    ...
    def test_previous(self):
        ...
        assert_array_almost_equal(interp10(1.5), np.array(1.0))
        assert_array_almost_equal(
            interp10([2.4, 5.6, 6.0]), np.array([2.0, 5.0, 6.0]),
        )
    ...
    def test_next(self):
        ...
        assert_array_almost_equal(interp10(1.5), np.array(2.0))
        assert_array_almost_equal(
            interp10([2.4, 5.6, 6.0]), np.array([3.0, 6.0, 6.0]),
        )
    ...
    def _bounds_check(self, kind="linear"):
        ...
        assert_array_equal(
            extrap10([[[11.2], [-3.4], [12.6], [19.3]]]), np.array(self.fill_value),
        )
        assert_array_equal(
