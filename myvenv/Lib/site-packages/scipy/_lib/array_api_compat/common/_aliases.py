...
def unique_all(x: ndarray, /, xp) -> UniqueAllResult:
    ...
    values, indices, inverse_indices, counts = xp.unique(
        x, return_counts=True, return_index=True, return_inverse=True, **kwargs,
    )
...
def unique_inverse(x: ndarray, /, xp) -> UniqueInverseResult:
    ...
    values, inverse_indices = xp.unique(
        x, return_counts=False, return_index=False, return_inverse=True, **kwargs,
    )
...
def unique_values(x: ndarray, /, xp) -> ndarray:
    kwargs = _unique_kwargs(xp)
    return xp.unique(
        x, return_counts=False, return_index=False, return_inverse=False, **kwargs,
    )
...
def argsort(
    ...
    **kwargs,
    ...
    if not descending:
        ...
        res = xp.flip(
            xp.argsort(xp.flip(x, axis=axis), axis=axis, **kwargs), axis=axis,
        )
