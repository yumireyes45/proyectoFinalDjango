...
class TestODR:
    ...
    def test_pearson(self):
        ...
        out = p_odr.run()
        assert_array_almost_equal(
            out.beta, np.array([5.4767400299231674, -0.4796082367610305]),
        )
        assert_array_almost_equal(
            out.sd_beta, np.array([0.3590121690702467, 0.0706291186037444]),
        )
        assert_array_almost_equal(
            out.cov_beta,
            np.array(
        ...
        rout = pr_odr.run()
        assert_array_almost_equal(
            rout.beta, np.array([11.4192022410781231, -2.0850374506165474]),
        )
        assert_array_almost_equal(
            rout.sd_beta, np.array([0.9820231665657161, 0.3070515616198911]),
        )
        assert_array_almost_equal(
            rout.cov_beta,
            np.array(
