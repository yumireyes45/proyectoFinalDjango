...
def _linprog_highs(
    ...
    **unknown_options,
    ...
    sol = {
        ...
        "slack": slack,
        "con": con,
        "ineqlin": OptimizeResult({"residual": slack, "marginals": marg_ineqlin,}),
        "eqlin": OptimizeResult({"residual": con, "marginals": marg_eqlin,}),
        "lower": OptimizeResult(
            {"residual": None if x is None else x - lb, "marginals": marg_lower,}
        ),
