...
class TestToDatetime:
    ...
    @pytest.mark.parametrize(
        "constructor", [Timestamp, lambda x: Timestamp(x).to_pydatetime()],
    )
    ...
    @pytest.mark.parametrize(
        "string, attribute", [("now", "utcnow"), ("today", "today"),],
    )
    ...
    @pytest.mark.parametrize(
        "arg, format", [("2001-01-01", "%Y-%m-%d"), ("01-01-2001", "%d-%m-%Y"),],
    )
...
class TestToDatetimeInferFormat:
    ...
    def test_to_datetime_iso8601_noleading_0s(self, cache, format):
        ...
        expected = Series(
            [Timestamp("2014-01-01"), Timestamp("2014-02-02"), Timestamp("2015-03-03"),]
        )
    ...
    def test_parse_dates_infer_datetime_format_warning(self):
        # GH 49024
        with tm.assert_produces_warning(
            UserWarning, match="The argument 'infer_datetime_format' is deprecated",
        ):
...
@pytest.mark.parametrize(
    "aware_val", [dtstr, Timestamp(dtstr)], ids=lambda x: type(x).__name__,
)
@pytest.mark.parametrize(
    "naive_val",
