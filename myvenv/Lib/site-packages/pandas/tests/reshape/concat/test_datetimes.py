...
class TestDatetimeConcat:
    ...
    def test_concat_multiindex_datetime_object_index(self):
        ...
        s = Series(
            ...
            index=MultiIndex.from_arrays(
                [[1, 2], idx[:-1],], names=["first", "second"],
            ),
        )
        s2 = Series(
            ["a", "b"],
            index=MultiIndex.from_arrays(
                [[1, 2], idx[::2]], names=["first", "second"],
            ),
        )
    ...
    def test_concat_NaT_series_dataframe_all_NaT(self, tz1, tz2):
        ...
        second = DataFrame(
            [[Timestamp("2015/01/01", tz=tz2)], [Timestamp("2016/01/01", tz=tz2)],],
            index=[2, 3],
        )
...
class TestTimezoneConcat:
    ...
    def test_concat_multiindex_with_tz(self):
        ...
        df = DataFrame(
            {
                "dt": DatetimeIndex(
                    [datetime(2014, 1, 1), datetime(2014, 1, 2), datetime(2014, 1, 3),],
