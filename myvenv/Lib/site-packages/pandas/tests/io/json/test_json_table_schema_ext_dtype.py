...
class TestTableSchemaType:
    ...
    @pytest.mark.parametrize(
        "string_data",
        [array(["pandas"], dtype="string"), Series(array(["pandas"], dtype="string")),],
    )
    ...
    @pytest.mark.parametrize(
        "integer_data",
        [array([10], dtype="Int64"), Series(array([10], dtype="Int64")),],
    )
...
class TestTableOrient:
    ...
    def test_build_decimal_series(self, dc):
        ...
        expected = OrderedDict(
            [("schema", schema), ("data", [OrderedDict([("id", 0), ("a", 10.0)])]),]
        )
    ...
    def test_build_string_series(self, sa):
        ...
        expected = OrderedDict(
            [("schema", schema), ("data", [OrderedDict([("id", 0), ("a", "pandas")])]),]
        )
