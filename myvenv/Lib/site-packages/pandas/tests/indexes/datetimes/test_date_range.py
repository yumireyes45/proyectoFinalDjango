...
def _get_expected_range(
    begin_to_match, end_to_match, both_range, inclusive_endpoints,
):
...
class TestDateRanges:
    ...
    @pytest.mark.parametrize(
        "freq,freq_depr",
        [("2ME", "2M"), ("2SME", "2SM"), ("2BQE", "2BQ"), ("2BYE", "2BY"),],
    )
    ...
    def test_range_with_tz_closed_with_tz_aware_start_end(
        ...
        expected_range = _get_expected_range(
            begintz, endtz, both_range, inclusive_endpoints_fixture,
        )
    ...
    @pytest.mark.parametrize(
        "freq,freq_depr",
        [("200YE", "200A"), ("YE", "Y"), ("2YE-MAY", "2A-MAY"), ("YE-MAY", "Y-MAY"),],
    )
