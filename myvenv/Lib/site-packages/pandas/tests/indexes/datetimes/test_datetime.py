...
class TestDatetimeIndex:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("AS-AUG", ["2021-08-01", "2022-08-01", "2023-08-01"], "YS-AUG",),
            ("1BAS-MAY", ["2021-05-03", "2022-05-02", "2023-05-01"], "1BYS-MAY",),
        ],
    )
    def test_AS_BAS_deprecated(self, freq_depr, expected_values, expected_freq):
        ...
        result = DatetimeIndex(
            expected_values, dtype="datetime64[ns]", freq=expected_freq,
        )
