...
class TestDataFrameToDict:
    ...
    @pytest.mark.parametrize(
        ...
        (
            ...
            [
                [datetime(2018, 1, 1), datetime(2019, 2, 2), datetime(2020, 3, 3),],
                Timestamp,
            ],
            [[1.0, 2.0, 3.0], float],
            [[1, 2, 3], int],
    ...
    @pytest.mark.parametrize(
        "orient", ["dict", "list", "split", "records", "index", "tight"],
    )
    @pytest.mark.parametrize(
        "data,expected_types",
        (
            ...
            (
                ...
                {"a": [int, int, int], "b": [float, float, float],},
            ),
            (  # Make sure we have one df which is all object type cols
                {"a": [1, "hello", 3], "b": [1.1, "world", 3.3],},
                {"a": [int, str, int], "b": [float, str, float],},
            ),
        ),
    )
