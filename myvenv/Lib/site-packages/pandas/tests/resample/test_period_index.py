    ...
    def _simple_period_range_series(start, end, freq="D"):
        with warnings.catch_warnings():
            ...
            warnings.filterwarnings(
                "ignore", msg, category=FutureWarning,
            )
...
class TestPeriodIndex:
    ...
    @pytest.mark.parametrize(
        ...
        [("2Q", "2q", "2Y", "2y", [0.5]), ("2M", "2m", "2Q", "2q", [1.0, 3.0]),],
    )
    ...
    @pytest.mark.parametrize(
        "offset",
        [offsets.MonthBegin(), offsets.BYearBegin(2), offsets.BusinessHour(2),],
    )
...
@pytest.mark.parametrize(
    "freq_depr", ["2BME", "2CBME", "2SME", "2BQE-FEB", "2BYE-MAR",],
)
