...
class TestDataFramePlots:
    ...
    def test_boxplot_vertical_subplots(self, hist_df):
        ...
        labels = [pprint_thing(c) for c in numeric_cols]
        axes = _check_plot_works(
            df.plot.box, default_axes=True, subplots=True, vert=False, logx=True,
        )
    ...
    @pytest.mark.slow
    @pytest.mark.parametrize(
        "kwargs", [{"logy": True}, {"logx": True, "logy": True}, {"loglog": True},],
    )
    ...
    @pytest.mark.parametrize(
        "xlabel, ylabel",
        [(None, None), ("X Label", None), (None, "Y Label"), ("X Label", "Y Label"),],
    )
    @pytest.mark.parametrize("kind", ["scatter", "hexbin"])
