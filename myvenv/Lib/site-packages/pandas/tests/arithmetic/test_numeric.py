...
class TestDivisionByZero:
    ...
    def test_ser_div_ser(
        self, switch_numexpr_min_elements, dtype1, any_real_numpy_dtype,
    ):
...
class TestAdditionSubtraction:
    ...
    def test_datetime64_with_index(self):
        ...
        ser = Series(
            date_range("20130101", periods=5), index=date_range("20130101", periods=5),
        )
        expected = ser - ser.index.to_series()
        result = ser - ser.index
        tm.assert_series_equal(result, expected)
...
class TestNumericArithmeticUnsorted:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (RangeIndex(0, 1000, 1), 2, Index(RangeIndex(0, 1000, 1)._values) // 2,),
            (RangeIndex(0, 100, 1), 2.0, Index(RangeIndex(0, 100, 1)._values) // 2.0,),
