...
def test_struct_accessor_dtypes():
            ...
            pa.struct(
                [
                    ...
                    (
                        "struct_col",
                        pa.struct(
                            [("int_col", pa.int64()), ("float_col", pa.float64()),]
                        ),
                    ),
                ]
            )
    ...
    expected = Series(
        [
            ...
            ArrowDtype(
                pa.struct([("int_col", pa.int64()), ("float_col", pa.float64()),])
            ),
        ],
...
def test_struct_accessor_field():
    ...
    ser = Series(
        ...
        dtype=ArrowDtype(
            pa.struct(
                [("rice", pa.float64()), ("maize", pa.int64()), ("wheat", pa.string()),]
            )
        ),
        index=index,
    )
    ...
    by_name_expected = Series(
        [-1, 0, 1], dtype=ArrowDtype(pa.int64()), index=index, name="maize",
    )
    tm.assert_series_equal(by_name, by_name_expected)

    by_index = ser.struct.field(2)
    by_index_expected = Series(
        ["a", "b", "c"], dtype=ArrowDtype(pa.string()), index=index, name="wheat",
    )
