...
def ffill_indexer(indexer: np.ndarray,) -> npt.NDArray[np.intp]: ...  # const intp_t[:]
def left_join_indexer_unique(
    left: np.ndarray, right: np.ndarray,  # ndarray[join_t]  # ndarray[join_t]
) -> npt.NDArray[np.intp]: ...
def left_join_indexer(
    left: np.ndarray, right: np.ndarray,  # ndarray[join_t]  # ndarray[join_t]
) -> tuple[
    np.ndarray, npt.NDArray[np.intp], npt.NDArray[np.intp],  # np.ndarray[join_t]
]: ...
