...
class GroupBy(BaseGroupBy[NDFrameT]):
    ...
    **Attributes**
    ...
    @final
    def _concat_objects(
        self, values, not_indexed_same: bool = False, is_transform: bool = False,
    ):
    ...
    def _transform_with_numba(self, func, *args, engine_kwargs=None, **kwargs):
        ...
        result = numba_transform_func(
            sorted_data, sorted_index, starts, ends, len(df.columns), *args,
        )
    ...
    def _value_counts(
        ...
        gb = df.groupby(
            groupings, sort=self.sort, observed=self.observed, dropna=self.dropna,
        )
    ...
    def expanding(self, *args, **kwargs) -> ExpandingGroupby:
        ...
        return ExpandingGroupby(
            self._selected_obj, *args, _grouper=self._grouper, **kwargs,
        )
    ...
    def _nth(
        self, n: PositionalIndexer | tuple, dropna: Literal["any", "all", None] = None,
    ) -> NDFrameT:
        if not dropna:
    ...
    def _idxmax_idxmin(
        ...
        result = self._agg_general(
            numeric_only=numeric_only, min_count=1, alias=how, skipna=skipna,
        )
        return result
