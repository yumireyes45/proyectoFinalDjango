...
with cf.config_prefix("display"):
    ...
    cf.register_option(
        "max_info_rows", 1690785, pc_max_info_rows_doc, validator=is_int,
    )
...
with cf.config_prefix("styler"):
    ...
    cf.register_option(
        "render.max_rows", None, styler_max_rows, validator=is_nonnegative_int,
    )

    cf.register_option(
        "render.max_columns", None, styler_max_columns, validator=is_nonnegative_int,
    )
