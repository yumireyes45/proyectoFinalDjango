...
class TimedeltaArray(dtl.TimelikeOps):
    ...
    def _from_sequence_not_strict(
        cls, data, *, dtype=None, copy: bool = False, freq=lib.no_default, unit=None,
    ) -> Self:
        """
    ...
    microseconds = _field_accessor(
        "microseconds", "microseconds", microseconds_docstring,
    )
...
def sequence_to_td64ns(
    data, copy: bool = False, unit=None, errors: DateTimeErrorChoices = "raise",
