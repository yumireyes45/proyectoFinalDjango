...
class DataFrame(NDFrame, OpsMixin):
        ...
        # For data is list-like, or Iterable (will consume into list)
            ...
            if len(data) > 0:
                ...
                if not isinstance(data, np.ndarray) and treat_as_nested(data):
                    ...
                    mgr = arrays_to_mgr(
                        arrays, columns, index, dtype=dtype, typ=manager,
                    )
                else:
                    mgr = ndarray_to_mgr(
                        data, index, columns, dtype=dtype, copy=copy, typ=manager,
    ...
    def _getitem_nocopy(self, key: list):
        ...
        new_mgr = self._mgr.reindex_indexer(
            new_axis, indexer, axis=0, allow_dups=True, copy=False, only_slice=True,
        )
    ...
    def set_axis(
        self, labels, *, axis: Axis = 0, copy: bool | None = None,
    ) -> DataFrame:
        ...
        *,
        ...
        if not drop:
            ...
            for i, (lev, lab) in reversed(list(enumerate(to_insert))):
                ...
                new_obj.insert(
                    0, name, level_values, allow_duplicates=allow_duplicates,
                )
    ...
    def _maybe_align_series_as_frame(self, series: Series, axis: AxisInt):
        ...
        return self._constructor(
            rvalues, index=self.index, columns=self.columns, dtype=rvalues.dtype,
        )
    ...
    def update(
        ...
        if not PYPY and using_copy_on_write():
            ...
            if sys.getrefcount(self) <= REF_COUNT:
                warnings.warn(
                    _chained_assignment_warning_method_msg, FutureWarning, stacklevel=2,
                )
        ...
        for col in self.columns.intersection(other.columns):
            ...
            with warnings.catch_warnings():
                warnings.filterwarnings(
                    "ignore", message="Downcasting behavior", category=FutureWarning,
                )
    ...
    def _gotitem(
        self, key: IndexLabel, ndim: int, subset: DataFrame | Series | None = None,
    ) -> DataFrame | Series:
        """
        ...
        if isinstance(values, dict):
            ...
            def isin_(x):
                ...
                result = algorithms.isin(
                    x.ravel(), values,  # type: ignore[arg-type]
                )
