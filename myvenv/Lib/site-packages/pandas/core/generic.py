...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    @final
    def set_flags(
        self, *, copy: bool_t = False, allows_duplicate_labels: bool_t | None = None,
    ) -> Self:
        """
    ...
    @doc(
        klass=_shared_doc_kwargs["klass"], optional_reindex="",
    )
    def reindex(
        self,
        labels=None,
    ...
    def _where(
        ...
        if isinstance(cond, NDFrame):
            ...
            if cond.ndim == 1 and self.ndim == 2:
                cond = cond._constructor_expanddim(
                    {i: cond for i in range(len(self.columns))}, copy=False,
                )
        ...
        with warnings.catch_warnings():
            warnings.filterwarnings(
                "ignore", "Downcasting object dtype arrays", category=FutureWarning,
            )
    ...
    def describe(self, percentiles=None, include=None, exclude=None,) -> Self:
        ...
        return describe_ndframe(
            obj=self, include=include, exclude=exclude, percentiles=percentiles,
    ...
    def min(
        ...
        **kwargs,
        ...
        return self._stat_function(
            "min", nanops.nanmin, axis, skipna, numeric_only, **kwargs,
        )
    ...
    def max(
        ...
        **kwargs,
        ...
        return self._stat_function(
            "max", nanops.nanmax, axis, skipna, numeric_only, **kwargs,
        )
    ...
    def prod(
        ...
        **kwargs,
        ...
        return self._min_count_stat_function(
            "prod", nanops.nanprod, axis, skipna, numeric_only, min_count, **kwargs,
        )
