...
def _cast_to_stata_types(data: DataFrame) -> DataFrame:
    ...
    if ws:
        warnings.warn(
            ws, PossiblePrecisionLoss, stacklevel=find_stack_level(),
        )
...
the string values returned are correct."""
            warnings.warn(
                msg, UnicodeWarning, stacklevel=find_stack_level(),
            )
...
class StataWriter(StataParser):
    ...
    def _check_column_names(self, data: DataFrame) -> DataFrame:
        ...
        if converted_names:
            ...
            warnings.warn(
                ws, InvalidColumnName, stacklevel=find_stack_level(),
            )
...
supported types."""
    ...
    def _write_header(
        self, data_label: str | None = None, time_stamp: datetime | None = None,
    ) -> None:
