...
class ParserBase:
    ...
    def _maybe_make_multi_index_columns(
        self, columns: Sequence[Hashable], col_names: Sequence[Hashable] | None = None,
    ...
    def _do_date_conversions(
        self, names: Index, data: DataFrame,
    ) -> tuple[Sequence[Hashable] | Index, DataFrame]:
        ...

    @overload
    def _do_date_conversions(
        self, names: Sequence[Hashable], data: Mapping[Hashable, ArrayLike],
            ...
            try:
                ...
                with warnings.catch_warnings():
                    ...
                    pre_parsed = parsing.try_parse_dates(
                        parsing.concat_date_cols(date_cols), parser=date_parser,
                    )
                    try:
    ...
    if isinstance(parse_spec, list):
        ...
        for new_name, colspec in parse_spec.items():
            ...
            _, col, old_names = _try_convert_dates(
                converter, colspec, data_dict, orig_names, target_name=new_name,
            )
