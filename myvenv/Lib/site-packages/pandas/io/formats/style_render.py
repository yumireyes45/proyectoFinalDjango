...
class StylerRenderer:
    ...
    def _generate_body_row(
        self, iter: tuple, max_cols: int, idx_lengths: dict,
    ):
        """
...
def _element(
    html_element: str, html_class: str | None, value: Any, is_visible: bool, **kwargs,
) -> dict:
    """
...
def _get_trimming_maximums(
    rn, cn, max_elements, max_rows=None, max_cols=None, scaling_factor: float = 0.8,
) -> tuple[int, int]:
    """
