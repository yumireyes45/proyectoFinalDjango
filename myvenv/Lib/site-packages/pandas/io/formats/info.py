...
class DataFrameInfo(_BaseInfo):
    ...
    def __init__(
        self, data: DataFrame, memory_usage: bool | str | None = None,
    ) -> None:
    ...
    def render(
        ...
        *,
        ...
        printer = _DataFrameInfoPrinter(
            info=self, max_cols=max_cols, verbose=verbose, show_counts=show_counts,
        )
    ...
    def render(
        ...
        *,
        ...
        printer = _SeriesInfoPrinter(
            info=self, verbose=verbose, show_counts=show_counts,
        )
        printer.to_buffer(buf)
    ...
    def _create_table_builder(self) -> _DataFrameTableBuilder:
        ...
        if self.verbose:
            return _DataFrameTableBuilderVerbose(
                info=self.info, with_counts=self.show_counts,
            )
...
class _DataFrameTableBuilderVerbose(_DataFrameTableBuilder, _TableBuilderVerboseMixin):
    ...
    def _gen_rows_without_counts(self) -> Iterator[Sequence[str]]:
        """Iterator with string representation of body data without counts."""
        yield from zip(
            self._gen_line_numbers(), self._gen_columns(), self._gen_dtypes(),
        )
...
class _SeriesTableBuilderVerbose(_SeriesTableBuilder, _TableBuilderVerboseMixin):
    ...
    def _gen_rows_with_counts(self) -> Iterator[Sequence[str]]:
        """Iterator with string representation of body data with counts."""
        yield from zip(
            self._gen_non_null_counts(), self._gen_dtypes(),
        )
