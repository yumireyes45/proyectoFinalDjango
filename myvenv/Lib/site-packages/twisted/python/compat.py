...
deprecatedModuleAttribute(
    Version("Twisted", 21, 2, 0), "Obsolete alias for io.IOBase", __name__, "FileType",
)
...
izip = zip
deprecatedModuleAttribute(
    Version("Twisted", 21, 2, 0), "Obsolete alias for zip() builtin", __name__, "izip",
)
...
deprecatedModuleAttribute(
    Version("Twisted", 21, 2, 0), "Use functools.reduce() directly", __name__, "reduce",
)
...
deprecatedModuleAttribute(
    Version("Twisted", 21, 2, 0), "Use http.cookiejar directly", __name__, "cookielib",
)
