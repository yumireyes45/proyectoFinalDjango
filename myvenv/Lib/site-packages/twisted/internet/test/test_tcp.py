...
def assertPeerClosedOnEMFILE(
    testCase, exhauster, reactor, runReactor, listen, connect,
):
    """
    ...
    testCase.assertRaises(
        ConnectionClosed, clientFactory.lostReason.raiseException,
    )
...
class TCPPortTestsBuilder(
    ReactorBuilder, ListenTCPMixin, TCPPortTestsMixin, StreamTransportTestsMixin,
):
    pass


class TCPFDPortTestsBuilder(
    ReactorBuilder, SocketTCPMixin, TCPPortTestsMixin, StreamTransportTestsMixin,
):
    pass
