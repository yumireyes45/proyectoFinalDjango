...
class Deferred(Awaitable[_SelfResultT]):
    ...
    def addCallbacks(
        ...
        callback: Union[
            ...
            Callable[..., Failure],
            Callable[..., Union[_NextResultT, Deferred[_NextResultT], Failure],],
        ],
        errback: Union[
            Callable[..., _NextResultT],
            Callable[..., Deferred[_NextResultT]],
    ...
    def addCallback(
        self,
        callback: Callable[
            Concatenate[_SelfResultT, _P], Union[Failure, Deferred[_NextResultT]],
        ],
        *args: _P.args,
        **kwargs: _P.kwargs,
    ) -> Deferred[_NextResultT]:
    ...
    def addCallback(
        self,
        callback: Callable[
            Concatenate[_SelfResultT, _P], Union[Deferred[_NextResultT], _NextResultT],
        ],
        *args: _P.args,
        **kwargs: _P.kwargs,
    ) -> Deferred[_NextResultT]:
    ...
    def addTimeout(
        ...
        onTimeoutCancel: Optional[
            Callable[
                [Union[_SelfResultT, Failure], float], Union[_NextResultT, Failure],
            ]
        ] = None,
    ) -> "Deferred[Union[_SelfResultT, _NextResultT]]":
        """
    ...
    def fromCoroutine(
        cls,
        coro: Union[
            Coroutine[Deferred[Any], Any, _T], Generator[Deferred[Any], Any, _T],
        ],
    ) -> "Deferred[_T]":
        """
...
def _gotResultInlineCallbacks(
    r: object,
    waiting: List[Any],
    gen: Union[Generator[Deferred[Any], Any, _T], Coroutine[Deferred[Any], Any, _T],],
...
def _cancellableInlineCallbacks(
    gen: Union[
        Generator[Deferred[Any], object, _T], Coroutine[Deferred[Any], object, _T],
    ]
) -> Deferred[_T]:
    """
