...
def certificatesForAuthorityAndServer(serviceIdentity="example.com"):
    ...
    caCertificate = (
        ...
        .add_extension(x509.BasicConstraints(ca=True, path_length=9), critical=True,)
        .sign(
    ...
    serverCertificate = (
        ...
        .add_extension(
            x509.SubjectAlternativeName(subjectAlternativeNames), critical=True,
        )
        .sign(
            private_key=privateKeyForCA,
            algorithm=hashes.SHA256(),
...
class OpenSSLOptionsTests(OpenSSLOptionsTestsMixin, TestCase):
    ...
    def test_singleUseKeys(self):
        ...
        """
        opts = sslverify.OpenSSLCertificateOptions(
            privateKey=self.sKey, certificate=self.sCert, enableSingleUseKeys=True,
        )
        opts._contextFactory = FakeContext
        ctx = opts.getContext()
    ...
    def test_methodIsDeprecated(self):
        ...
        """
        sslverify.OpenSSLCertificateOptions(
            privateKey=self.sKey, certificate=self.sCert, method=SSL.SSLv23_METHOD,
        )
    ...
    def test_dhParams(self):
        ...
        opts = sslverify.OpenSSLCertificateOptions(
            privateKey=self.sKey, certificate=self.sCert, dhParameters=dhParams,
        )
        opts._contextFactory = FakeContext
        ctx = opts.getContext()
...
class ServiceIdentityTests(SynchronousTestCase):
    ...
    def serviceIdentitySetup(
        ...
        if buggyInfoCallback:
            ...
            self.patch(
                sslverify.ClientTLSOptions, "_identityVerifyingInfoCallback", broken,
            )
    ...
    def test_invalidHostname(self):
        ...
        cProto, sProto, cWrapped, sWrapped, pump = self.serviceIdentitySetup(
            "wrong-host.example.com", "correct-host.example.com",
        )
        self.assertEqual(cWrapped.data, b"")
    ...
    def test_validHostnameInvalidCertificate(self):
        ...
        """
        cProto, sProto, cWrapped, sWrapped, pump = self.serviceIdentitySetup(
            "valid.example.com", "valid.example.com", validCertificate=False,
        )
...
class NPNOrALPNTests(TestCase):
    ...
    def test_NPNAndALPNSuccess(self):
        ...
        negotiatedProtocol, lostReason = negotiateProtocol(
            clientProtocols=protocols, serverProtocols=protocols,
        )
    ...
    def test_NPNAndALPNNoAdvertise(self):
        ...
        protocols = [b"h2", b"http/1.1"]
        negotiatedProtocol, lostReason = negotiateProtocol(
            clientProtocols=protocols, serverProtocols=[],
        )
    ...
    def test_NPNAndALPNNoOverlap(self):
        ...
        negotiatedProtocol, lostReason = negotiateProtocol(
            serverProtocols=clientProtocols, clientProtocols=serverProtocols,
        )
        self.assertIsNone(negotiatedProtocol)
...
class MultipleCertificateTrustRootTests(TestCase):
    ...
    def test_trustRootSelfSignedServerCertificate(self):
        ...
        selfSigned = sslverify.PrivateCertificate.fromCertificateAndKeyPair(
            sslverify.Certificate(cert), sslverify.KeyPair(key),
        )
    ...
    def test_trustRootFromCertificatesOpenSSLObjects(self):
        ...
        exception = self.assertRaises(
            TypeError, sslverify.trustRootFromCertificates, [certX509],
        )
        self.assertEqual(
...
class OpenSSLCipherTests(TestCase):
    ...
    def test_eqSameNameDifferentType(self):
        ...
        self.assertNotEqual(
            sslverify.OpenSSLCipher(self.cipherName), DifferentCipher(),
        )
...
class AcceptableCiphersTests(TestCase):
    ...
    def test_selectReturnsOnlyFromAvailable(self):
        ...
        ac = sslverify.OpenSSLAcceptableCiphers(
            [sslverify.OpenSSLCipher("A"), sslverify.OpenSSLCipher("B"),]
        )
        self.assertEqual(
...
class FakeCryptoState:
    ...
    def __init__(
        self, getEllipticCurveRaises, getEllipticCurveReturns,
    ):
...
class FakeCryptoTests(SynchronousTestCase):
    ...
    def test_get_elliptic_curveRecordsArgument(self):
        ...
        state = FakeCryptoState(
            getEllipticCurveRaises=None, getEllipticCurveReturns=None,
        )
    ...
    def test_get_elliptic_curveReturns(self):
        ...
        returnValue = "object"
        state = FakeCryptoState(
            getEllipticCurveRaises=None, getEllipticCurveReturns=returnValue,
        )
        crypto = FakeCrypto(state)
        self.assertIs(
            crypto.get_elliptic_curve("another curve name"), returnValue,
        )
    ...
    def test_get_elliptic_curveRaises(self):
        ...
        crypto = FakeCrypto(state)
        self.assertRaises(
            ValueError, crypto.get_elliptic_curve, "yet another curve name",
        )
        self.assertEqual(
            state.getEllipticCurveCalls, ["yet another curve name"],
        )
...
class ChooseDiffieHellmanEllipticCurveTests(SynchronousTestCase):
    ...
    def test_openSSL110(self):
        ...
        chooser = sslverify._ChooseDiffieHellmanEllipticCurve(
            self.OPENSSL_110, openSSLlib=self.lib, openSSLcrypto=self.crypto,
        )
    ...
    def test_openSSL102(self):
        ...
        chooser = sslverify._ChooseDiffieHellmanEllipticCurve(
            self.OPENSSL_102, openSSLlib=self.lib, openSSLcrypto=self.crypto,
        )
    ...
    def test_openSSL101(self):
        ...
        chooser = sslverify._ChooseDiffieHellmanEllipticCurve(
            self.OPENSSL_101, openSSLlib=self.lib, openSSLcrypto=self.crypto,
        )
        chooser.configureECDHCurve(self.context)
