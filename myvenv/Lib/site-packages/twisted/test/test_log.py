...
class FileObserverTests(LogPublisherTestCaseMixin, unittest.SynchronousTestCase):
    ...
    def test_emitPrefix(self) -> None:
        ...
        self.assertTrue(
            result.startswith(prefix), f"{result!r} does not start with {prefix!r}",
        )
    ...
    def test_emitNewline(self) -> None:
        ...
        self.assertTrue(
            result.endswith(suffix), f"{result!r} does not end with {suffix!r}",
        )
...
class PythonLoggingObserverTests(unittest.SynchronousTestCase):
    ...
    def test_errorString(self) -> None:
        ...
        self.assertTrue(
            output.startswith(prefix), f"Does not start with {prefix!r}: {output!r}",
        )
