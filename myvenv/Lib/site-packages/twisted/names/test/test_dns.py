...
class DomainStringTests(unittest.SynchronousTestCase):
    def test_bytes(self):
        ...
        """
        self.assertEqual(
            b"twistedmatrix.com", dns.domainString(b"twistedmatrix.com"),
        )
...
class NameTests(unittest.TestCase):
    ...
    def test_unknown(self):
        ...
        self.assertEqual(
            msg.queries, [dns.Query(b"foo.bar", type=0xDEAD, cls=0xBEEF),],
        )
        self.assertEqual(
            msg.answers,
            [
...
class MessageTests(unittest.SynchronousTestCase):
    ...
    def test_reprNonDefautFields(self):
        ...
        self.assertEqual(
            "<Message " "id=10 " "opCode=20 " "rCode=30 " "maxSize=40" ">", repr(m),
        )
...
class CompactReprTests(unittest.SynchronousTestCase):
    ...
    def test_flagsIfSet(self):
        ...
        self.assertEqual(
            "<Foo " "alwaysShowField='AS' " "flags=flagTrue,flagFalse" ">", repr(m),
        )
