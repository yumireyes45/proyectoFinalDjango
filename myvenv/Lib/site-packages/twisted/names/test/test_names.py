...
class AuthorityTests(unittest.TestCase):
    ...
    def test_recordMissing(self):
        ...
        authority = NoFileAuthority(
            ...
            records={soa_record.mname.name: [soa_record, dns.Record_NS("1.2.3.4"),]},
        )
    ...
    def _referralTest(self, method):
        ...
        authority = NoFileAuthority(
            soa=(soa_record.mname.name, soa_record), records={subdomain: [nameserver,]},
        )
...
class AdditionalProcessingTests(unittest.TestCase):
    ...
    def _lookupSomeRecords(self, method, soa, makeRecord, target, addresses):
        ...
        authority = NoFileAuthority(
            ...
            records={soa.mname.name: [makeRecord(target)], target: addresses,},
        )
...
class SecondaryAuthorityServiceTests(unittest.TestCase):
    ...
    def test_constructAuthorityFromBytes(self):
        ...
        service = SecondaryAuthorityService(
            primary.encode(), [b"example.net", "example.edu"],  # Coerced to bytes.
        )
        self.assertEqual(service.primary, primary)
...
class BindAuthorityTests(unittest.TestCase):
    ...
    def test_aRecords(self):
        ...
        for dom, ip in [
            ...
            self.assertEqual(
                dns.Record_A(ip, 604800,), rr.payload,
            )
    ...
    def test_aaaaRecords(self):
        ...
        self.assertEqual(
            dns.Record_AAAA("2001:db8:10::1", 604800,), rr.payload,
        )
    ...
    def test_mxRecords(self):
        ...
        self.assertEqual(
            dns.Record_MX(preference=10, name="mx.example.com", ttl=604800,),
            rr.payload,
        )
    ...
    def test_cnameRecords(self):
        ...
        rr = answers[0]
        self.assertEqual(
            dns.Record_CNAME(name="example.com", ttl=604800,), rr.payload,
        )
...
class PySourceAuthorityTests(unittest.TestCase):
    ...
    def test_aaaaRecords(self):
        ...
        self.assertEqual(
            dns.Record_AAAA("2001:db8:10::1"), rr.payload,
        )
    ...
    def test_mxRecords(self):
        ...
        self.assertEqual(
            dns.Record_MX(preference=10, name="mail.example.com",), rr.payload,
        )
    ...
    def test_cnameRecords(self):
        ...
        rr = answers[0]
        self.assertEqual(
            dns.Record_CNAME(name="example.com",), rr.payload,
        )
    ...
    def test_PTR(self):
        ...
        rr = answers[0]
        self.assertEqual(
            dns.Record_PTR(name=b"no-in.example.com",), rr.payload,
        )
