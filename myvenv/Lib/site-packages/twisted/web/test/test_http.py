...
class GenericHTTPChannelTests(unittest.TestCase):
    ...
    def test_h2CancelsH11Timeout(self):
        ...
        hamcrest.assert_that(
            ...
            hamcrest.contains(
                hamcrest.has_property("cancelled", hamcrest.equal_to(False),),
            ),
        )
    ...
    def test_http2_absent(self):
        ...
        b.negotiatedProtocol = b"h2"
        self.assertRaises(
            ValueError, self._negotiatedProtocolForTransportInstance, b,
        )
    ...
    def test_unknownProtocol(self):
        ...
        self.assertRaises(
            AssertionError, self._negotiatedProtocolForTransportInstance, b,
        )
...
class ChunkedTransferEncodingTests(unittest.TestCase):
    ...
    def test_extensionsMalformed(self):
        ...
        for b in invalidControl + invalidDelimiter + invalidDel:
            ...
            p = http._ChunkedTransferDecoder(
                lambda b: None, lambda b: None,  # pragma: nocov  # pragma: nocov
            )
    ...
    def test_malformedChunkEnd(self):
        ...
        """
        p = http._ChunkedTransferDecoder(
            lambda b: None, lambda b: None,  # pragma: nocov
        )
        self.assertRaises(
            http._MalformedChunkedDataError, p.dataReceived, b"3\r\nabc!!!!"
        )
    ...
    def test_unfinishedTrailerHeader(self):
        ...
        p.dataReceived(b"3\r\nabc\r\n0\r\n0123456789")
        self.assertRaises(
            http._MalformedChunkedDataError, p.dataReceived, b"A",
        )
...
class ParsingTests(unittest.TestCase):
    ...
    def test_headersMultiline(self):
        ...
        # header-value.
        self.assertEqual(
            request.requestHeaders.getRawHeaders(b"nospace"), [b"nospace"],
        )
        self.assertEqual(
            request.requestHeaders.getRawHeaders(b"space"), [b"space space"],
        )
        self.assertEqual(
            request.requestHeaders.getRawHeaders(b"spaces"), [b"spaces spaces spaces"],
        )
        self.assertEqual(
    ...
    def test_headerStripWhitespace(self):
        ...
        # header-value.
        self.assertEqual(
            request.requestHeaders.getRawHeaders(b"spaces"), [b"spaces were stripped"],
        )
        self.assertEqual(
            request.requestHeaders.getRawHeaders(b"tabs"), [b"tabs were stripped"],
        )
        self.assertEqual(
    ...
    def test_invalidContentLengthHeader(self):
        ...
        self.assertRequestRejected(
            [b"GET / HTTP/1.0", b"Content-Length: x", b"", b"",]
        )
    ...
    def test_invalidHeaderNoColon(self):
        ...
        """
        self.assertRequestRejected(
            [b"GET / HTTP/1.0", b"HeaderName ", b"", b"",]
        )
    ...
    def test_invalidHeaderWhitespaceBeforeColon(self):
        ...
        """
        self.assertRequestRejected(
            [b"GET / HTTP/1.0", b"HeaderName : foo", b"", b"",]
        )
...
class HTTPChannelSanitizationTests(unittest.SynchronousTestCase):
    ...
    def test_writeHeadersSanitizesLinearWhitespace(self):
        ...
        for component in bytesLinearWhitespaceComponents:
            ...
            self.assertEqual(
                transport.value(),
                b"\r\n".join([b"HTTP/1.1 200 OK", sanitizedHeaderLine, b"",]),
            )
