...
class LocalWorkerAMP(AMP):
    ...
    def _buildFailure(
        self, error: WorkerException, errorClass: str, frames: List[str],
    ) -> Failure:
        """
    ...
    def addError(
        self, testName: str, errorClass: str, errorStreamId: int, framesStreamId: int,
    ) -> Dict[str, bool]:
        """
    ...
    def addFailure(
        self, testName: str, failStreamId: int, failClass: str, framesStreamId: int,
    ) -> Dict[str, bool]:
        """
...
class LocalWorker(ProcessProtocol):
    ...
    def __init__(
        self, ampProtocol: LocalWorkerAMP, logDirectory: FilePath[Any], logFile: TextIO,
    ):
    ...
    def connectionMade(self):
        ...
        d = self._ampProtocol.callRemote(
            workercommands.Start, directory=self._logDirectory.path,
        )
