...
class FormattingTests(unittest.TestCase):
    ...
    def test_formatAttributeSubscript(self) -> None:
        ...
        self.assertEqual(
            "bar qux",
            self.format(
                "{example.config[foo]} {example.config[baz]}", example=Example(),
            ),
        )
...
class TimeFormattingTests(unittest.TestCase):
    ...
    def test_formatTimeWithDefaultFormat(self) -> None:
        ...
        # UTC
        testForTimeZone(
            "UTC+00", None, "2007-01-31T00:00:00+0000",
        )
        ...
        # No DST
        testForTimeZone(
            "CST+06", None, "2007-01-31T00:00:00-0600",
        )
...
class ClassicLogFormattingTests(unittest.TestCase):
    ...
    def test_formatNamespace(self) -> None:
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), "- [my.namespace\x23-] XYZZY\n",
        )
    ...
    def test_formatLevel(self) -> None:
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), "- [-\x23warn] XYZZY\n",
        )
    ...
    def test_formatSystem(self) -> None:
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), "- [S.Y.S.T.E.M.] XYZZY\n",
        )
    ...
    def test_formatSystemUnformattable(self) -> None:
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), "- [UNFORMATTABLE] XYZZY\n",
        )
    ...
    def test_formatFormat(self) -> None:
        ...
        self.assertEqual(
            formatEventAsClassicLogText(event), "- [-\x23-] id:123\n",
        )
...
class EventAsTextTests(unittest.TestCase):
    ...
    def test_eventAsTextSystemOnly(self) -> None:
        ...
        eventText = eventAsText(
            event, includeTimestamp=False, includeTraceback=False, includeSystem=True,
        )
        self.assertEqual(
    ...
    def test_eventAsTextTimestampOnly(self) -> None:
        ...
        event["log_failure"] = f
        eventText = eventAsText(
            event, includeTimestamp=True, includeTraceback=False, includeSystem=False,
        )
        self.assertEqual(
