...
class TestURL(HyperlinkTestCase):
    ...
    def test_fragmentEquality(self):
        ...
        self.assertEqual(
            URL.from_text("http://localhost/#"), URL.from_text("http://localhost/"),
        )
    ...
    def test_click(self):
        ...
        self.assertEqual(
            "http://www.foo.com/a/nice/path/?zot=23&zut", urlpath.click("").to_text(),
        )
        # A simple relative path remove the query.
        self.assertEqual(
            "http://www.foo.com/a/nice/path/click", urlpath.click("click").to_text(),
        )
        ...
        self.assertEqual(
            "http://www.foo.com/a/nice/path/?burp", urlpath.click("?burp").to_text(),
        )
        ...
        self.assertEqual(
            "http://www.foo.com/me/17?spam=158", u.click("/me/17?spam=158").to_text(),
        )
        ...
        for start, click, expected in tests:
            ...
            self.assertEqual(
                ...
                "{start}.click({click}) => {actual} not {expected}".format(
                    start=start, click=repr(click), actual=actual, expected=expected,
                ),
            )
    ...
    def test_invalid_port(self):
        ...
        self.assertRaises(
            ValueError, URL.from_text, "http://reader.googlewebsite.com:neverforget",
        )
    ...
    def test_netloc_slashes(self):
        ...
        url = URL(
            scheme="git+ftp", path=("x", "y", "z", ""), rooted=True, uses_netloc=True,
        )
