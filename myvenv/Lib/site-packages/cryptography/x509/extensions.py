...
class PolicyConstraints(ExtensionType):
    ...
    def __init__(
        self, require_explicit_policy: int | None, inhibit_policy_mapping: int | None,
    ) -> None:
...
class UserNotice:
    def __init__(
        self, notice_reference: NoticeReference | None, explicit_text: str | None,
    ) -> None:
...
class NoticeReference:
    def __init__(
        self, organization: str | None, notice_numbers: typing.Iterable[int],
    ) -> None:
...
class NameConstraints(ExtensionType):
    ...
    @property
    def permitted_subtrees(self,) -> list[GeneralName] | None:
        return self._permitted_subtrees

    @property
    def excluded_subtrees(self,) -> list[GeneralName] | None:
...
class GeneralNames:
    ...
    def get_values_for_type(
        self, type: type[DNSName] | type[UniformResourceIdentifier] | type[RFC822Name],
    ) -> list[str]:
        ...

    @typing.overload
    def get_values_for_type(self, type: type[DirectoryName],) -> list[Name]:
        ...

    @typing.overload
    def get_values_for_type(self, type: type[RegisteredID],) -> list[ObjectIdentifier]:
        ...
...
class IssuingDistributionPoint(ExtensionType):
    ...
    @property
    def only_some_reasons(self,) -> frozenset[ReasonFlags] | None:
