...
class PSS(AsymmetricPadding):
    ...
    def __init__(
        self, mgf: MGF, salt_length: int | _MaxLength | _Auto | _DigestLength,
    ) -> None:
        self._mgf = mgf
...
class OAEP(AsymmetricPadding):
    ...
    def __init__(
        self, mgf: MGF, algorithm: hashes.HashAlgorithm, label: bytes | None,
    ):
...
def calculate_max_pss_salt_length(
    key: rsa.RSAPrivateKey | rsa.RSAPublicKey, hash_algorithm: hashes.HashAlgorithm,
) -> int:
