...
class Backend:
    ...
    def __init__(self) -> None:
        ...
        self._cipher_registry: dict[
            tuple[type[CipherAlgorithm], type[Mode]], typing.Callable,
        ] = {}
    ...
    def openssl_assert(
        self, ok: bool, errors: list[rust_openssl.OpenSSLError] | None = None,
    ) -> None:
    ...
    def load_key_and_certificates_from_pkcs12(
        ...
        PrivateKeyTypes | None, x509.Certificate | None, list[x509.Certificate],
    ]:
